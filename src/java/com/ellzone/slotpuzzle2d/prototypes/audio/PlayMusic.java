...
public class PlayMusic extends SPPrototype {
    Music music;
    float songDuration;
    ...
    void setSong (Song song) {
        ...
        switch (song) {
            default:
            case MP3:
                music = Gdx.audio.newMusic(Gdx.files.internal("sounds/8.12.mp3"));
                songDuration = 183;
                break;
            case OGG:
                music = Gdx.audio.newMusic(Gdx.files.internal("sounds/cloudconnected.ogg"));
                songDuration = 22;
                break;
            case WAV:
                music = Gdx.audio.newMusic(Gdx.files.internal("sounds/8.12.loop.wav"));
                songDuration = 4;
                break;
        }
