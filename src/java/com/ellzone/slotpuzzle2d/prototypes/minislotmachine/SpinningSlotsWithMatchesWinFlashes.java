...
public class SpinningSlotsWithMatchesWinFlashes extends SPPrototypeTemplate {
    ...
    private void addReel(Texture slotReelScrollTexture, int i) {
        ...
        animatedReel.getReel().addListener(new SpinningSlotsWithMatchesWinFlashes.ReelStoppedListener().invoke());
