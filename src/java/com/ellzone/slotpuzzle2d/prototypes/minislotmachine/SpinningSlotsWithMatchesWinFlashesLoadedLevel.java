...
public class SpinningSlotsWithMatchesWinFlashesLoadedLevel extends SPPrototypeTemplate {
    ...
    private HoldLightButton myLightButton;
...
//        lightButtons.add(myLightButton);
    ...
    private void createLevel(Array<RectangleMapObject> levelRectangleMapObjects) throws IllegalAccessException {
        for (RectangleMapObject rectangleMapObject : levelRectangleMapObjects) {
            ...
            try {
                ...
                myLightButton =  (HoldLightButton) constructor.newInstance(constructorParanetersValues);
            } catch (Exception ex) {
                System.out.println(ex.getMessage());
            }

            if (myLightButton != null) {
                Field field = null;
                try {
                ...
                myLightButton.addTo(field.get(this));
            }
        }
    }
