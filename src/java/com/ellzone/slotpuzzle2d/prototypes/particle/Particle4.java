...
public class Particle4 extends SPPrototype {
    ...
    private void initialiseReelSlots() {
        ...
        reelTile = new ReelTile(slotReelScrollTexture, slotReelScrollTexture.getHeight(), 0, 32, spriteWidth, spriteHeight, spriteWidth, spriteHeight, 0);
        reelTile.setX(0);
        reelTile.setY(0);
        reelTile.setSx(0);
        reelTile.setSy(0);
    ...
    private void initialiseDampenedSine() {
        ...
        dampenedSine = new DampenedSine(0,
                                         reelTiles.get(0).getSy(),
                                        0,
                                        0,
                                        0,
                                        slotReelScrollheight * 20,
                                         slotReelScrollheight,
                                         reelTiles.get(0).getEndReel(),
                                         (int) reelTiles.get(0).getWidth());
