...
import com.ellzone.slotpuzzle2d.prototypes.artemis.system.SlotPuzzleUsingTweenSystem;

import net.mostlyoriginal.plugin.OperationsPlugin;
import net.mostlyoriginal.plugin.ProfilerPlugin;

public class TweenUsingArtemis extends SPPrototype {
    ...
    private World createWorld() {
        return new World(new WorldConfigurationBuilder()
                ...
                .with(
                        new SlotPuzzleUsingTweenSystem()
                )
                .build());
    }
