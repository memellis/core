...
public class SpinningSlotsSetSizeOfSlots extends SPPrototypeTemplate {
    ...
    private void initialiseReelSlots() {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            animatedReel.getReel().setReelDisplaySize(20, 60);
    ...
    private boolean isSlotHandleTouched() {
        return slotHandleSprite.getBoundingRectangle().contains(touch);
    }
